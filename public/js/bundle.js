...
exports.updatePSW = exports.update = exports.signup = exports.logout = exports.login = void 0;
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 3:
            ...
            if (res.data.status === "success") {
              (0, _alerts.showAlert)('success', 'Log Out in successfully!');
              window.setTimeout(function () {
        ...
        switch (_context3.prev = _context3.next) {
          ...
          case 7:
            ...
            if (error.indexOf("E11000 duplicate key") === 0) {
              (0, _alerts.showAlert)('error', "Your email or username or phone is already used");
...
function () {
  ...
  /*#__PURE__*/
  regeneratorRuntime.mark(function _callee5(Currentpassword, Newpassword, ConfirmeNewpassword) {
    var res;
  ...
  return function updatePSW(_x5, _x6, _x7) {
    return _ref5.apply(this, arguments);
  };
}();

exports.updatePSW = updatePSW;
},{"axios":"../../node_modules/axios/index.js","./alerts":"alerts.js"}],"addproduct.js":[function(require,module,exports) {
"use strict";
...
function () {
  var _ref = _asyncToGenerator(
  /*#__PURE__*/
  regeneratorRuntime.mark(function _callee(name, type, state, user, category, color, size, description, price, quantity, wilaya, phone, email, seller) {
    var neWproduct, img, dress_type, makeup_type, clothes_type, others_type, res;
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.prev = 0;
            neWproduct = {};
            img = ["empty.png", "empty.png", "empty.png"];
          ...
          case 8:
            ...
            if (res.data.status === "success") {
              ...
              window.setTimeout(function () {
                location.assign("/addimages/".concat(res.data.data.Modal._id));
              }, 100);
            }
  ...
  return function addproduct(_x, _x2, _x3, _x4, _x5, _x6, _x7, _x8, _x9, _x10, _x11, _x12, _x13, _x14) {
    return _ref.apply(this, arguments);
  };
}();

exports.addproduct = addproduct;
},{"axios":"../../node_modules/axios/index.js"}],"deleteproduct.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.addimages = exports.deleteProduct = void 0;
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            return axios({
              method: "DELETE",
              url: "http://localhost:3000/api/v1/products/".concat(product)
            });
...
function () {
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            ...
            return axios({
              method: "PATCH",
              url: "http://localhost:3000/api/v1/products/".concat(id),
              data: data
            });
          ...
          case 3:
            ...
            if (res.data.status === "success") {
              console.log("updated successfully");
              (0, _alerts.showAlert)('success', 'images Product added');
              location.assign("/me/sale");
            }
  ...
  return function addimages(_x2, _x3) {
    return _ref2.apply(this, arguments);
  };
}();

exports.addimages = addimages;
},{"./alerts":"alerts.js"}],"favory.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.deleteFavory = exports.addFavory = void 0;
...
function () {
  var _ref = _asyncToGenerator(
  /*#__PURE__*/
  regeneratorRuntime.mark(function _callee(product, user) {
    var res;
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            if (res.data.status === "success") {
              (0, _alerts.showAlert)('success', 'Product successfully added');
  ...
  return function addFavory(_x, _x2) {
    return _ref.apply(this, arguments);
  };
}();

exports.addFavory = addFavory;
...
function () {
  var _ref2 = _asyncToGenerator(
  /*#__PURE__*/
  regeneratorRuntime.mark(function _callee2(favory) {
    var res;
    return regeneratorRuntime.wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            ...
            return axios({
              method: "DELETE",
              url: "http://localhost:3000/api/v1/favory/".concat(favory)
            });
          ...
          case 3:
            ...
            if (res.data.status === "success") {
              (0, _alerts.showAlert)('success', 'Product successfully deleted');
  ...
  return function deleteFavory(_x3) {
    return _ref2.apply(this, arguments);
  };
}();

exports.deleteFavory = deleteFavory;
},{"./alerts":"alerts.js"}],"commentary.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.display_comment = exports.addComment = void 0;
...
function () {
  var _ref = _asyncToGenerator(
  /*#__PURE__*/
  regeneratorRuntime.mark(function _callee(comment, user, product, username) {
    var res;
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            if (res.data.status === "success") {
              document.getElementById("allCommentary").insertAdjacentHTML("afterbegin", "<div class=\"flex br-top mb-2\" > \n            <image src=\"./img/user.jpg\" style=\"width:40px; height:40px; border-radius:50%;\"/> \n            <div class=\"flex flex-col ml-4\"> \n                  <div class=\"text-xl cl-dark mt-2\"> ".concat(username, " </div> \n                  <div class=\"text-md cl-dark-2 \"> ").concat(comment, " </div> \n                  <div class=\"text-md cl-grey\"> Published today </div> \n            </div>      \n        </div>"));
            }
...
function () {
  var _ref2 = _asyncToGenerator(
  /*#__PURE__*/
  regeneratorRuntime.mark(function _callee2(lenght, id) {
    var get_com, all;
    return regeneratorRuntime.wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            ...
            _context2.next = 4;
            return axios.get("http://localhost:3000/api/v1/commentary?limit=3&page=".concat(lenght / 3 + 1), {
              params: {
                product: id
              }
            });
          ...
          case 4:
            get_com = _context2.sent;
            all = get_com.data.data.data;
            console.log(all);

            if (all && all.length > 0) {
              all.forEach(function (one) {
                var mydate2 = new Date(one.createdAt);
                var mydate3 = new Date();
                var date_com = mydate2.toLocaleString("en-us", {
                  day: "numeric",
                  month: "long",
                  year: "numeric"
                });
                var date_now = mydate3.toLocaleString("en-us", {
                  day: "numeric",
                  month: "long",
                  year: "numeric"
                });
                ...
                document.getElementById("allCommentary").insertAdjacentHTML("beforeend", "<div class=\"flex br-top mb-2\" > \n              <image src=\"./img/user.jpg\" style=\"width:40px; height:40px; border-radius:50%;\"/> \n              <div class=\"flex flex-col ml-4\"> \n                    <div class=\"text-xl cl-dark mt-2\"> ".concat(one.user.username, " </div> \n                    <div class=\"text-md cl-dark-2 \"> ").concat(one.comment, " </div> \n                    <div class=\"text-md cl-grey\"> Published ").concat(date, " </div> \n              </div>      \n          </div>"));
              });
            } else {
  ...
  return function display_comment(_x5, _x6) {
    return _ref2.apply(this, arguments);
  };
}();

exports.display_comment = display_comment;
...
var stepThree = document.getElementById("step-3"); // const stepFour = document.getElementById("step-4");

var addNewComment = document.getElementById("addComment");
var commentary = document.getElementById("commentary");
var showcom = document.getElementById("showcom");
var addfavory = document.getElementById("addfavory");
var deletefavory = document.getElementById("deletefavory");
var deleteproduct = document.getElementById("deleteproduct");
var updatePsw = document.getElementById("updatePsw");
var addimgs = document.getElementById("addimgs");
var search = document.getElementById("search");
var searchtop = document.getElementById("Searchtop");
var icon_st = document.getElementById("icon_st");
var icon_st_1 = document.getElementById("icon_st_1");
var name,
    type,
    state,
    user,
...
if (addimgs) {
  addimgs.addEventListener("submit", function (e) {
    e.preventDefault();
    ...
    (0, _deleteproduct.addimages)(form, id);
  });
}
...
if (signupForm) {
  signupForm.addEventListener("submit", function (e) {
    ...
    var form = {};
    form.last_name = document.getElementById("last_name").value, form.first_name = document.getElementById("first_name").value, form.username = document.getElementById("username").value, form.email = document.getElementById("email").value, form.phone = document.getElementById("phone").value, form.password = document.getElementById("password").value, form.passwordconfirm = document.getElementById("confirm_password").value;
    form.phone = parseInt(form.phone, 10).toString();
    var zero = "0";
    form.phone = zero.concat("", form.phone);

    if (form.phone.length != 10 || form.phone[0] !== "0" || form.phone[1] !== "5" && form.phone[1] !== "6" && form.phone[1] !== "7") {
      (0, _alerts.showAlert)("error", "give us a correct number");
    } else if (!form.last_name || !form.first_name || !form.username || !form.email || !form.password || !form.passwordconfirm) {
      (0, _alerts.showAlert)("error", "tell us all your information");
    } else {
...
if (updateForm) {
  updateForm.addEventListener("submit", function (e) {
    ...
    if (phone.length != 10 || phone[0] !== "0" || phone[1] !== "5" && phone[1] !== "6" && phone[1] !== "7") {
      (0, _alerts.showAlert)("error", "give us a correct number");
    } else {
      (0, _login.update)(form);
    }
  });
}

if (updatePsw) {
  updatePsw.addEventListener("submit", function (e) {
    e.preventDefault();
    var cupsw = document.getElementById("upCurPassword").value;
    var npsw = document.getElementById("upPassword").value;
    var cpsw = document.getElementById("upConfirm_password").value;
    (0, _login.updatePSW)(cupsw, npsw, cpsw);
  });
}
...
if (stepOne) {
  stepOne.addEventListener("submit", function (e) {
    e.preventDefault();
    ...
    if (name && user && type && state) {
      ...
      if (type === "Dress") {
        ...
        cates = document.getElementById("category").getAttribute("data-dress").split(",");
      } else if (type === "MakeUp") {
        cates = document.getElementById("category").getAttribute("makeup-type").split(",");
      } else if (type === "Clothes") {
        cates = document.getElementById("category").getAttribute("clothes-type").split(",");
      } else {
        cates = document.getElementById("category").getAttribute("others-type").split(",");
      }

      document.getElementById("category").innerHTML += "<option value=\"\" > --Please choose category-- </option>";
      cates.forEach(function (cat) {
        document.getElementById("category").innerHTML += "<option value=\"".concat(cat, "\" > ").concat(cat, " </option>");
      });
    } else {
      (0, _alerts.showAlert)("error", "tell us all product information");
    }
  });
}

if (stepTwo) {
  stepTwo.addEventListener("submit", function (e) {
    e.preventDefault();
...
if (stepThree) {
  stepThree.addEventListener("submit", function (e) {
    e.preventDefault();
    ...
    if (wilaya && phone && email) {
      (0, _addproduct.addproduct)(name, type, state, user, category, color, size, desc, price, quantity, wilaya, phone, email, seller);
    } else {
      (0, _alerts.showAlert)("error", "tell us all product information");
    }
  });
...
if (img) {
  var product = JSON.parse(document.getElementById("img-1").getAttribute("data-product"));
  img_1.addEventListener("click", function () {
    img.innerHTML = "<image src=\"./img/products/".concat(product.images[0], "\"  > </image>");
  });
  img_2.addEventListener("click", function (e) {
    e.preventDefault();
    img.innerHTML = "<image src=\"./img/products/".concat(product.images[1], "\"> </image>");
  });
  img_3.addEventListener("click", function () {
    img.innerHTML = "<image src=\"./img/products/".concat(product.images[2], "\"> </image>");
  });
}

var img_mob = document.getElementById("img-mob");
var img_1_mob = document.getElementById("img-1-mob");
var img_2_mob = document.getElementById("img-2-mob");
var img_3_mob = document.getElementById("img-3-mob");

if (img_mob) {
  var _product = JSON.parse(document.getElementById("img-1-mob").getAttribute("data-product"));

  img_1_mob.addEventListener("touchend", function () {
    img_mob.innerHTML = "<image src=\"./img/products/".concat(_product.images[0], "\"  > </image>");
  });
  img_2_mob.addEventListener("touchend", function (e) {
    e.preventDefault();
    img_mob.innerHTML = "<image src=\"./img/products/".concat(_product.images[1], "\"> </image>");
  });
  img_3_mob.addEventListener("touchend", function () {
    img_mob.innerHTML = "<image src=\"./img/products/".concat(_product.images[2], "\"> </image>");
  });
}
...
if (addNewComment) {
  addNewComment.addEventListener("click", function (e) {
    e.preventDefault();
    var text = commentary.value;
    var user = addNewComment.getAttribute("data-user");
    var username = addNewComment.getAttribute("data-username");
    var product = addNewComment.getAttribute("data-product");
    commentary.value = "";
    (0, _commentary.addComment)(text, user, product, username);
  });
} // Commentary


if (showcom) {
  showcom.addEventListener("click", function (e) {
    e.preventDefault();
    var product = addNewComment.getAttribute("data-product");
    var nbr = document.getElementById("allCommentary").childElementCount;
    (0, _commentary.display_comment)(nbr, product);
  });
} // Favory


if (addfavory) {
  addfavory.addEventListener("click", function (e) {
    var user = JSON.parse(document.getElementById("addfavory").getAttribute("data-user"));
    var product = JSON.parse(document.getElementById("addfavory").getAttribute("data-product"));
    (0, _favory.addFavory)(product._id, user._id);
  });
}

if (deletefavory) {
  deletefavory.addEventListener("click", function () {
    var favory = document.getElementById("deletefavory").getAttribute("data-favory");
    (0, _favory.deleteFavory)(favory);
  });
}

if (deleteproduct) {
  deleteproduct.addEventListener("click", function () {
    var product = document.getElementById("deleteproduct").getAttribute("data-product");
    (0, _deleteproduct.deleteProduct)(product);
  });
} // Search
...
if (search) {
  search.addEventListener("submit", function (e) {
    ...
    if (state != "--Please choose an option--") {
      ...
      link += "state=".concat(state);
    }

    if (size != "--Please choose an option--" && size != "--he doesn't have this option--") {
      form.size = size;
    ...
    if (color != "SEVERAL COLORS") {
      ...
      link += "color=".concat(color);
    }

    var tab = window.location.href.split("product");
...
if (icon_st) {
  icon_st.addEventListener("click", function () {
    if (searchtop.value) {
      var tab = window.location.href.split("product");
      var link = tab[0] + "product-fastsearch" + "?search=".concat(searchtop.value);
      location.assign(link);
    }
  });
}
...
if (icon_st_1) {
  icon_st_1.addEventListener("click", function () {
    if (searchtop.value) {
      var tab = window.location.href.split("product");
      var link = tab[0] + "product-fastsearch" + "?search=".concat(searchtop.value);
      location.assign(link);
